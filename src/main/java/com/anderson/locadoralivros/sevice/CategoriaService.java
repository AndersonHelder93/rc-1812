...
public class CategoriaService {
	...
	private CategoriaRepository repository; // Injeta e traz as funcionalidades do objeto instanciado na classe repository, onde realiza as consultas e inserções
